...
{                                                   }
{***************************************************}
unit C4D.Wizard.AiAssistant.Ask.Frame;
...
uses
  ...
  System.Generics.Collections, Vcl.Grids, Vcl.DBGrids, Vcl.Buttons,
  Data.DB, System.DateUtils,System.StrUtils, FireDAC.Stan.Intf,
  ...
  C4D.Wizard.AiAssistant.Lexer,
  C4D.Wizard.AiAssistant.Thread,
  C4D.Wizard.AiAssistant.History;
...
type
  ...
  public
    ...
    procedure OnUpdateMessage(var Msg: TMessage); message TC4DConsts.WM_UPDATE_MESSAGE;
    procedure OnProgressMessage(var Msg: TMessage); message TC4DConsts.WM_PROGRESS_MESSAGE;
...
begin
  ...
  FCellCloseBtn.Glyph.LoadFromResourceName(HInstance, 'c4d_ai_close');
