...
{                                                   }
{***************************************************}
unit C4D.Wizard.AiAssistant.Thread;
...
uses
  ...
  C4D.Wizard.AiAssistant.XSuperObject,
...
begin
  ...
  PostMessage(FHandle, TC4DConsts.WM_PROGRESS_MESSAGE, 1, 0);
end;
...
begin
  ...
  FProxySetting.Free;
  PostMessage(FHandle, TC4DConsts.WM_PROGRESS_MESSAGE, 0, 0);
  inherited;
end;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          begin
            if not Terminated then
              SendMessage(FHandle, TC4DConsts.WM_UPDATE_MESSAGE, Integer(LvResult), 0);
          end
          else
          begin
            ...
            begin
              ...
              begin
                Sleep(1);
                if not Terminated then
                  SendMessage(FHandle, TC4DConsts.WM_UPDATE_MESSAGE, Integer(LvResult[I]), 1);
              end;
            end;
          end;
          SendMessage(FHandle, TC4DConsts.WM_UPDATE_MESSAGE, 0, 2);
        end
        else
        begin
          SendMessageW(FHandle, TC4DConsts.WM_UPDATE_MESSAGE, Integer(LvResult), 0);
          SendMessage(FHandle, TC4DConsts.WM_UPDATE_MESSAGE, 0, 2);
        end;
      end;
    except on E: Exception do
      begin
        Sleep(10);
        SendMessageW(FHandle, TC4DConsts.WM_UPDATE_MESSAGE, Integer(E.Message), 3);
        Terminate;
      end;
    end;
  finally
