...
{                                                   }
{***************************************************}
unit C4D.Wizard.AiAssistant.Editor.Helper;

interface
uses
  ToolsAPI, System.SysUtils, System.Classes, C4D.Wizard.Consts;
...
begin
  ...
  begin
    ...
    PositionInsertText(AEditView.Position, TC4DConsts.AI_ASSISTANT_CRLF);
